                        ...
                        if (!string.IsNullOrWhiteSpace(currentReferenceTypeCodedOther) && !string.IsNullOrWhiteSpace(xnRefNumber))
                        {
                            switch (currentReferenceTypeCodedOther.Replace(" ", "").ToLower())
                            {
                                ...
                                case MeridianGlobalConstants.XCBL_NEW_ORDER_NUMBER:
                                    ...
                                    processData.CsvFileName = string.Concat(MeridianGlobalConstants.XCBL_AWC_FILE_PREFIX, fileNameFormat, formattedNewOrder, MeridianGlobalConstants.XCBL_FILE_EXTENSION);
                                    processData.XmlFileName = string.Concat(MeridianGlobalConstants.XCBL_AWC_FILE_PREFIX, fileNameFormat, formattedNewOrder, MeridianGlobalConstants.XCBL_XML_EXTENSION);
                                    break;
