...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'Country', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'CONTC000Master', @level2type = N'COLUMN', @level2name = N'ConBusinessCountryRegion';
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'State', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'CONTC000Master', @level2type = N'COLUMN', @level2name = N'ConBusinessStateProvince';
