...
namespace M4PL.EF
{
    ...
    public partial class VEND010Contacts
    {
        public long Id { get; set; }
        public Nullable<long> VendVendorID { get; set; }
        public Nullable<int> VendItemNumber { get; set; }
        public string VendContactCode { get; set; }
        public string VendContactTitle { get; set; }
        public Nullable<long> VendContactMSTRID { get; set; }
