...
//Date Programmed:                              2020/04/23
//Program Name:                                 ESignSQLSerializer
//Purpose:                                      Used to Provide ESign  Serialization
//====================================================================================================================================================
...
{
    public class ESignSQLSerializer
    {
        [Flags]
        ...
        public static string ESignConnectionConnectionStringName = "ESignConnection"; //M4PL ConnectionString
        ...
        static ESignSQLSerializer()
        {
        }

        public ESignSQLSerializer()
        {
            if (ConfigurationManager.ConnectionStrings[ESignConnectionConnectionStringName] == null)
                throw new InvalidOperationException(string.Format("Invalid default connection string name: {0}",
                    ESignConnectionConnectionStringName));
            _connection =
                new SqlConnection(ConfigurationManager.ConnectionStrings[ESignConnectionConnectionStringName].ConnectionString);
            _command = _connection.CreateCommand();
        }

        public ESignSQLSerializer(ConnectionStringSettings connectionStringSetting)
        {
        ...
        public ESignSQLSerializer(string connectionString)
        {
