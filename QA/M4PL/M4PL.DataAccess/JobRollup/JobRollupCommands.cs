...
namespace M4PL.DataAccess.JobRollup
{
	...
	{
		public static List<RollupList> GetRollupList(long programId)
		{
		...
		public static List<JobRollupList> GetJobRollupList(long programId)
		{
			List<JobRollupList> result = null;
			int completedCount = 0;
			var rollupList = GetRollupList(programId);
