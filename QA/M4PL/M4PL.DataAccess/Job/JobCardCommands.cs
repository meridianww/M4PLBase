...
namespace M4PL.DataAccess.Job
{
    public class JobCardCommands : BaseCommands<Entities.Job.JobCard>
    {
        ...
        /// <returns></returns>
        public static IList<JobCardTileDetail> GetCardTileData(ActiveUser activeUser, string DashboardName)
        {
            var parameters = new[]
            {
            ...
            var result = SqlSerializer.Default.DeserializeMultiRecords<JobCardTileDetail>(StoredProceduresConstant.GetCardTileData, parameters, storedProcedure: true);
