...
namespace M4PL.DataAccess.Job
{
    public class JobCardCommands : BaseCommands<Entities.Job.JobCard>
    {
        ...
        public static IList<Entities.Job.JobCard> GetDropDownDataForJobCard(ActiveUser activeUser, long customerId)
        {
            var parameters = new List<Parameter>
                  {
            ...
            var destinationRecord = SqlSerializer.Default.DeserializeMultiRecords<Entities.Job.JobCard>(StoredProceduresConstant.GetDestinationRecordsByCustomer, parameters.ToArray(), storedProcedure: true);
