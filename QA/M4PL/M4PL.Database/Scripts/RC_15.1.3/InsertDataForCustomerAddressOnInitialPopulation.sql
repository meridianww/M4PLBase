...
From [dbo].[CUST000Master] CM
INNER JOIN dbo.[COMP000Master] COMP ON COMP.CompPrimaryRecordId = CM.Id AND CompTableName = 'Customer'
LEFT JOIN [dbo].[CONTC000Master] CC ON CC.Id = CM.CustCorporateAddressId
Where CM.CustOrgId = 1
UNION
...
From [dbo].[CUST000Master] CM
INNER JOIN dbo.[COMP000Master] COMP ON COMP.CompPrimaryRecordId = CM.Id AND CompTableName = 'Customer'
LEFT JOIN [dbo].[CONTC000Master] CC ON CC.Id = CM.CustBusinessAddressId
Where CM.CustOrgId = 1
UNION
...
From [dbo].[CUST000Master] CM
INNER JOIN dbo.[COMP000Master] COMP ON COMP.CompPrimaryRecordId = CM.Id AND CompTableName = 'Customer'
LEFT JOIN [dbo].[CONTC000Master] CC ON CC.Id = CM.CustWorkAddressId
Where CM.CustOrgId = 1