...
namespace M4PL.Web.Tests.Controls
{
   public class OrganizationControls
    {
        public const string OrgDVSMenuBar = "OrganizationGridView_DXCTMenu0";
        ...
        public const string SearchedRow = "/html/body/div[2]/div/div/table/tbody/tr[3]/td/div/table/tbody/tr/td[3]/div/div[2]/table/tbody/tr/td/div[3]/table/tbody/tr[4]/td[2]";
        public const string PageTopBar = "OrganizationGridView_DXPagerTop";

        public const string OrgGrid = "OrganizationGridView_DXDataRow0";
        ...
        public const string OrgPOCStatusBar = "OrgPocContactGridView_tcStatusBar";
        public const string OrgPOCGridEmptyRow = "OrgPocContactGridView_DXEmptyRow";
        public const string OrgPOCGrid = "OrgPocContactGridView_DXDataRow0";
        public const string OrgPOCNew = "OrgPocContactGridView_DXContextMenu_Rows_DXI0_";
        public const string OrgPOCEdit = "OrgPocContactGridView_DXContextMenu_Rows_DXI1_T";
        public const string OrgPOCChooseColumn = "OrgPocContactGridView_DXContextMenu_Rows_DXI2_T";
        ...
        public const string OrgCredGridEmptyRow = "OrgCredentialGridView_DXEmptyRow";
        ...
        public const string OrgActRolStatusBar = "OrgActRoleGridView_tcStatusBar";



        // Organization Ref Role Data View Screen

        public const string OrgRefRolStatusBar = "OrgRefRoleGridView_tcStatusBar";
        ...
        public const string OrgRefRolToggleFilterRow0 = "OrgRefRoleGridView_DXDataRow0";
        public const string SecModuleClick = "SecurityByRoleGridView_DXDataRow-1";

        public const string OrgRefRoleCodeSearch = "OrgRefRoleGridView_DXFREditorcol2_I";
        public const string OrgRefRolToggleFilterRow = "OrgRefRoleGridView_DXFilterRow";
        public const string FilterBoxChecked = "OrgRefRoleGridView_DXFilterBar_CBFilterEnabled";
        ...
        public const string OrgActRoleMenuBar = "OrgActRoleGridView_DXCTMenu0";
