...
namespace M4PL.Business.Finance.NavRate
{
	...
	/// </summary>
	public interface INavRateCommands : IBaseCommands<Entities.Finance.Customer.NavRate>
	{
		StatusModel GenerateProgramPriceCostCode(List<Entities.Finance.Customer.NavRate> navRateList);
	}
}