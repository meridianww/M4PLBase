...
//Purpose:                                      Contains Actions to render view on AppDashboard over the Pages in the system
//====================================================================================================================================================*/
...
namespace M4PL.Web.Areas.Administration.Controllers
{
    public class AppDashboardController : BaseDashboardController
    {
        ...
        public AppDashboardController(IAppDashboardCommands appDashboardCommands, ICommonCommands commonCommands)
            : base(DashboardConfig.AppDashboardConfigurator(commonCommands))
        {
        ...
        public ActionResult Dashboard(string strRoute)
        {
            ...
            route.SetParent(EntitiesAlias.AppDashboard, _commonCommands.Tables[EntitiesAlias.AppDashboard].TblMainModuleId);
            ...
            return PartialView(MvcConstants.View_Dashboard, _dashboardResult);
        }
