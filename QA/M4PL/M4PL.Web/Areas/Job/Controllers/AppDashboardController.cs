...
//Purpose:                                      Contains Actions to render view on Jobs's AppDashboard page
//====================================================================================================================================================*/
...
namespace M4PL.Web.Areas.Job.Controllers
{
    public class AppDashboardController : BaseDashboardController
    {
        ...
        public AppDashboardController(IAppDashboardCommands appDashboardCommands, ICommonCommands commonCommands)
           : base(DashboardConfig.JobAppDashboardConfigurator(commonCommands, commonCommands.Tables[EntitiesAlias.Job].TblMainModuleId))
        {
