...
//Program Name:                                 JobDashboardController
//Purpose:                                      Contains Actions to render view on JobDashboard page
//====================================================================================================================================================*/
...
namespace M4PL.Web.Areas.Job.Controllers
{
    public class JobDashboardController : MvcBaseController
    {
        ...
        public override ActionResult RibbonMenu(string strRoute)
        {
            ...
            ribbonMenus.ForEach(r => r.RibbonRoute(route, ribbonMenus.IndexOf(r), new MvcRoute { Entity = EntitiesAlias.JobDashboard, Area = EntitiesAlias.Job.ToString() }, _commonCommands, SessionProvider));
