...
//Program Name:                                 VendDashboardController
//Purpose:                                      Contains Actions to render view on Vendor's VendDashboard page
//====================================================================================================================================================*/
...
{
    public class VendDashboardController : MvcBaseController
    {
        ...
        public VendDashboardController(ICommonCommands commonCommands)
        {
        ...
        {
            var route = JsonConvert.DeserializeObject<MvcRoute>(strRoute);
            route.SetParent(EntitiesAlias.VendDashboard, _commonCommands.Tables[EntitiesAlias.Vendor].TblMainModuleId);
        ...
        public override ActionResult RibbonMenu(string strRoute)
        {
            ...
            ribbonMenus.ForEach(r => r.RibbonRoute(route, ribbonMenus.IndexOf(r), new MvcRoute { Entity = EntitiesAlias.VendDashboard, Area = EntitiesAlias.Vendor.ToString() }, _commonCommands, SessionProvider));
