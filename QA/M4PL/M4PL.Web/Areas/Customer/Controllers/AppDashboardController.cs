...
//Purpose:                                      Contains Actions to render view on Customer's AppDashboard
//====================================================================================================================================================*/
...
namespace M4PL.Web.Areas.Customer.Controllers
{
    public class AppDashboardController : BaseDashboardController
    {
        ...
        public AppDashboardController(IAppDashboardCommands appDashboardCommands, ICommonCommands commonCommands)
           : base(DashboardConfig.CustAppDashboardConfigurator(commonCommands, commonCommands.Tables[EntitiesAlias.Customer].TblMainModuleId))
        {
        ...
        public ActionResult Dashboard(string strRoute)
        {
            ...
            System.Web.HttpContext.Current.Session[WebApplicationConstants.UserTheme] = SessionProvider.UserSettings.Settings.GetSettingByEntityAndName(_commonCommands.GetSystemSetting().Settings, EntitiesAlias.System, WebApplicationConstants.Theme).ToString();
            DevExpress.Web.ASPxWebControl.GlobalTheme = Convert.ToString(System.Web.HttpContext.Current.Session[WebApplicationConstants.UserTheme]);
