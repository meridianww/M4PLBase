...
//Program Name:                                 ScrDashboardController
//Purpose:                                      Contains Actions to render view on ScrDashboard page
//====================================================================================================================================================*/
...
{
    public class ScrDashboardController : MvcBaseController
    {
        ...
        public ScrDashboardController(ICommonCommands commonCommands)
        {
        ...
        {
            var route = JsonConvert.DeserializeObject<MvcRoute>(strRoute);
            route.SetParent(EntitiesAlias.ScrDashboard, _commonCommands.Tables[EntitiesAlias.Scanner].TblMainModuleId);
        ...
        public override ActionResult RibbonMenu(string strRoute)
        {
            ...
            ribbonMenus.ForEach(r => r.RibbonRoute(route, ribbonMenus.IndexOf(r), new MvcRoute { Entity = EntitiesAlias.ScrDashboard, Area = EntitiesAlias.Scanner.ToString() }, _commonCommands, SessionProvider));
