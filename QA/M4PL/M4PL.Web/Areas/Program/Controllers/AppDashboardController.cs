...
//Purpose:                                      Contains Actions to render view on Program's AppDashboard page
//====================================================================================================================================================*/
...
namespace M4PL.Web.Areas.Program.Controllers
{
    public class AppDashboardController : BaseDashboardController
    {
        ...
        public AppDashboardController(IAppDashboardCommands appDashboardCommands, ICommonCommands commonCommands)
           : base(DashboardConfig.ProgramAppDashboardConfigurator(commonCommands, commonCommands.Tables[EntitiesAlias.Program].TblMainModuleId))
        {
