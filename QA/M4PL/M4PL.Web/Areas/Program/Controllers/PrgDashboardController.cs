...
//Program Name:                                 PrgDashboardController
//Purpose:                                      Contains Actions to render view on Program's PrgDashboard page
//====================================================================================================================================================*/
...
{
	public class PrgDashboardController : MvcBaseController
	{
		...
		public PrgDashboardController(ICommonCommands commonCommands)
		{
		...
		{
			var route = JsonConvert.DeserializeObject<MvcRoute>(strRoute);
			route.SetParent(EntitiesAlias.PrgDashboard, _commonCommands.Tables[EntitiesAlias.Program].TblMainModuleId);
		...
		public override ActionResult RibbonMenu(string strRoute)
		{
			...
			ribbonMenus.ForEach(r => r.RibbonRoute(route, ribbonMenus.IndexOf(r), new MvcRoute { Entity = EntitiesAlias.PrgDashboard, Area = EntitiesAlias.Program.ToString() }, _commonCommands, SessionProvider));
