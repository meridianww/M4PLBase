...
//Program Name:                                 OrgDashboardController
//Purpose:                                      Contains Actions to render view on Organization's OrgDashboard page
//====================================================================================================================================================*/
...
{
    public class OrgDashboardController : MvcBaseController
    {
        ...
        public OrgDashboardController(ICommonCommands commonCommands)
        {
        ...
        {
            var route = JsonConvert.DeserializeObject<MvcRoute>(strRoute);
            route.SetParent(EntitiesAlias.OrgDashboard, _commonCommands.Tables[EntitiesAlias.Organization].TblMainModuleId);
        ...
        public override ActionResult RibbonMenu(string strRoute)
        {
            ...
            ribbonMenus.ForEach(r => r.RibbonRoute(route, ribbonMenus.IndexOf(r), new MvcRoute { Entity = EntitiesAlias.OrgDashboard, Area = EntitiesAlias.Organization.ToString() }, _commonCommands, SessionProvider));
