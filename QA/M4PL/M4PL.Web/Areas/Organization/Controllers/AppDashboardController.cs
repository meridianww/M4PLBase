...
//Purpose:                                      Contains Actions to render view on Organization's AppDashboard page
//====================================================================================================================================================*/
...
namespace M4PL.Web.Areas.Organization.Controllers
{
  ...
  : base(DashboardConfig.OrgAppDashboardConfigurator(commonCommands, commonCommands.Tables[EntitiesAlias.Organization].TblMainModuleId))
        {
