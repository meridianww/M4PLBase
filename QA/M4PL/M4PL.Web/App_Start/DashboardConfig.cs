...
namespace M4PL.Web
{
	...
	{
		private static DashboardConfigurator appDashboardConfigurator;
		private static DashboardConfigurator orgAppDashboardConfigurator;
		private static DashboardConfigurator custAppDashboardConfigurator;
		private static DashboardConfigurator vendAppDashboardConfigurator;

		private static DashboardConfigurator programAppDashboardConfigurator;
		private static DashboardConfigurator jobAppDashboardConfigurator;
		private static DashboardConfigurator contactAppDashboardConfigurator;
