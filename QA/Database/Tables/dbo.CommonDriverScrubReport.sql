...
CREATE TABLE [dbo].[CommonDriverScrubReport](
 ...
 CONSTRAINT [PK_CommonDriverScrubReport] PRIMARY KEY CLUSTERED 
(
	[Id] ASC
...
ALTER TABLE [dbo].[CommonDriverScrubReport]  WITH CHECK ADD  CONSTRAINT [FK_CommonDriverScrubReport_DriverScrubReportMaster] FOREIGN KEY([DriverScrubReportMasterId])
REFERENCES [dbo].[DriverScrubReportMaster] ([Id])
GO

ALTER TABLE [dbo].[CommonDriverScrubReport] CHECK CONSTRAINT [FK_CommonDriverScrubReport_DriverScrubReportMaster]
GO
