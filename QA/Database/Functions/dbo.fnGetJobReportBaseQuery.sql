...
BEGIN
	...
	AS (
		...
		WHERE tbl.[SysRefName] = @tableName
			...
			AND Col.ColColumnName NOT IN ('StartDate', 'EndDate', 'IB','OB','DE','Before5PMDeliveryWindow','ApptScheduledBeforeReceiving','FourHrWindowDeliveryCompliance','ManualScanningVsTotal','OverallRating' )
		)
