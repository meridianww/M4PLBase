...
IF NOT EXISTS(SELECT 1 FROM SYSTM000Ref_Options WHERE SysLookupCode='Status' AND SysOptionName ='Cancel')
BEGIN
	...
	VALUES (39, 'Status', 'Cancel', @MaxCountID, 0, 0, 1, '2017-05-04 12:50:39.99', NULL, '2019-12-05 10:54:42.613', 'nfujimoto')
END