...
VALUES ('EN', 'PrgRefGatewayDefault', NULL, 'PgdGatewayDefaultComplete', 'Default Complete', 'Default Complete', 'Default Complete', NULL, NULL, NULL, 23, 1, 1, 1, 1, NULL, 0, 0, NULL, 0)
END
