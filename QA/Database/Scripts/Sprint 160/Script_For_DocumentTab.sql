...
BEGIN
INSERT INTO [dbo].[SYSTM030Ref_TabPageName] (LangCode, RefTableName, TabSortOrder, TabTableName, TabPageTitle, TabExecuteProgram, TabPageIcon, StatusId, DateEntered, EnteredBy, DateChanged, ChangedBy)
VALUES ('EN', 'JobDocReference', 4, 'JobDocReference', 'Image', 'DocImageDataView', NULL, 1, GetDate(), 'System', NULL, NULL)
END
...
BEGIN
INSERT INTO [dbo].[SYSTM030Ref_TabPageName] (LangCode, RefTableName, TabSortOrder, TabTableName, TabPageTitle, TabExecuteProgram, TabPageIcon, StatusId, DateEntered, EnteredBy, DateChanged, ChangedBy)
VALUES ('EN', 'JobDocReference', 5, 'JobDocReference', 'POD', 'DocDeliveryPodDataView', NULL, 1, GetDate(), 'System', NULL, NULL)
END
IF NOT EXISTS(Select 1 From [dbo].[SYSTM030Ref_TabPageName] Where RefTableName = 'JobDocReference' AND TabTableName = 'Signature')
BEGIN
INSERT INTO [dbo].[SYSTM030Ref_TabPageName] (LangCode, RefTableName, TabSortOrder, TabTableName, TabPageTitle, TabExecuteProgram, TabPageIcon, StatusId, DateEntered, EnteredBy, DateChanged, ChangedBy)
VALUES ('EN', 'JobDocReference', 6, 'JobDocReference', 'Signature', 'DocSignatureDataView', NULL, 1, GetDate(), 'System', NULL, NULL)
END